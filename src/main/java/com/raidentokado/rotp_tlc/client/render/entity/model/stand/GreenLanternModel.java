package com.raidentokado.rotp_tlc.client.render.entity.model.stand;
...
public class GreenLanternModel extends HumanoidStandModel<GreenLanternEntity> {

	final ModelRenderer spine_r1;

	public GreenLanternModel() {
		super();
