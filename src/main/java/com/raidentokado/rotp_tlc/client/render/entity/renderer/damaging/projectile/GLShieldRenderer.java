...
public class GLShieldRenderer extends EntityRenderer<GLShieldEntity> {
    private static final ResourceLocation GLINT_TEXTURE = new ResourceLocation(RotpTLCAddon.MOD_ID, "textures/entity/gl_shield.png");

    public GLShieldRenderer(EntityRendererManager renderManager) {
        super(renderManager);
    }

    @Override
    public ResourceLocation getTextureLocation(GLShieldEntity entity) {
        return GLINT_TEXTURE;
    }

    @Override
    public void render(GLShieldEntity entity, float yRotation, float partialTick,
