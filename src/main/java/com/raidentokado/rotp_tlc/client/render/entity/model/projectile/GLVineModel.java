package com.raidentokado.rotp_tlc.client.render.entity.model.projectile;
...
public class GLVineModel<T extends OwnerBoundProjectileEntity> extends RepeatingModel<T> {
